...
namespace Assets.Scripts.LevelScripts
{
    public class Level06Events : LevelEvents
    {
        ...
        protected override void RegisterEvents()
        {
            ...
            levelStartedMessage.Message = " Mhh, hier geht’s nicht weiter, mein Herr. Wir müssen einen anderen Weg finden!";
            ...
            potionCollectedMessage.Message = "Sieht aus wie eine Art Zaubertrank. Ein kleines Wildschwein ist auf der Flasche abgebildet. (Grunz Grunz). Laut Etikett soll er übermenschliche Kräfte verleihen!";
